package com.example.reddyz.masterflow;
...
import com.example.reddyz.masterflow.dummy.DummyContent;
...
public class webpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((WebView) rootView.findViewById(R.id.web_view_area)).loadUrl(mItem.details);
        }
